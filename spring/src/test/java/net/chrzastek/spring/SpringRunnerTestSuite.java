package net.chrzastek.spring;

import net.chrzastek.spring.shape.Circle;
import net.chrzastek.spring.shape.Shape;
import net.chrzastek.spring.shape.Square;
import net.chrzastek.spring.shape.Triangle;
